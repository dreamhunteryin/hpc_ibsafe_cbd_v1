...
srun python infer/eval_lora.py --config {config_path}
...
def schedule(args: Namespace) -> None:
    ...
    run = save_dir.name
    script_path = save_dir / f'eval_{run}.job'
...
def parse_args(args=None):
    parser = ArgumentParser(description="Image classification fine-tuning with HF + torchvision Mixup/CutMix")
    # Seed
    ...
    parser.add_argument('--gpu', type=str, nargs='+',
                        default=('h200', 'h100', 'a100hgx', 'a100', 'a40', 'l40s'),
